...
const Hero = () => {
  return (
    <div className="flex flex-col md:items-center sm:text-center m-auto font-medium gap-2 p-5 dark:bg-grey-850">
      <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-5 leading-tight  max-w-250">
        Create, inspect, and apply synthetic surveillance broadly.
      </h1>{" "}
      <p className=" max-w-250 text-secondary-400 md:text-lg">
        Start with a stunning homepage. Stay motivated without hurting your
        pocket.
      </p>{" "}
      <div className=" p-2 px-5 bg-linear-to-r  cursor-pointer from-orange-500-start to-orange-500-end w-fit sm:m-auto rounded-full text-sm text-white font-medium mt-5">
        Start for free
      </div>{" "}
      <div className="hidden sm:flex gap-1 item-center text-center sm:m-auto text-xs pt-3">
      ...
      <div className="sm:hidden flex gap-1 item-center text-center sm:m-auto text-xs pt-3 mt-5">
        <span className="text-secondary-300">
          Want to talk or get a live demo?
        </span>{" "}
        <span className="flex items-center text-secondary-500">
