...
const Testimonials = () => {
  return (
    <div className="p-8 bg-outer-bg2 dark:bg-grey-800 flex flex-col gap-10 py-20 items-stretch">
      {/* item1  */}
      <div className="grid lg:grid-cols-2 place-items-center gap-20 lg:gap-10 max-w-280 m-auto items-stretch text-sm md:text-lg text-pretty">
        <div className=" flex flex-col w-full h-full gap-8 text-grey-750 dark:text-white/90 max-w-180 md:w-11/12">
          <Image
            ...
            width={100}
            height={100}
            className="size-18 testimonial-img"
          />
          <p className="text-lg testimonial-item ">
          ...
          <div className="flex items-center gap-3 testimonial-item">
            <Image
        ...
        <div className="flex flex-col w-full h-full gap-8 text-grey-750 dark:text-white/90 max-w-180 md:w-11/12">
          <Image
            ...
            width={100}
            height={100}
            className="size-18 testimonial-img2"
          />
          <p className="text-lg testimonial-item2 ">
          ...
          <div className="flex items-center gap-3 testimonial-item2">
            <Image
